...
class APIBaseClass:
    ...
    def call(self):
        ...
        print("____encyptped data_____ ",data)
        # endregion
    ...
    def decrypt_response_data(self, method='Basic'):
        ...
        print("__received response data ___",self.response.text)
        ...
        print("_____received response_____",self.response.text)
        try:
            if method == 'Basic':
